...
fun! Test_highlight() abort
  ...
  call gopher#coverage#_highlight({'cnt': 1, 'startline': 3, 'startcol': 0, 'endline': 3, 'endcol': 4})
  call gopher#coverage#_highlight({'cnt': 0, 'startline': 5, 'startcol': 0, 'endline': 6, 'endcol': 5})
